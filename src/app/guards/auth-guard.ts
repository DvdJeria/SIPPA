...
import { SupabaseService } from '../services/supabase'; // 🚨 CORRECCIÓN: Usar .service para la ruta típica
import { SqliteService } from '../services/sqlite'; // 🚨 CORRECCIÓN: Usar .service para la ruta típica
